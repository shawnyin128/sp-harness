---
name: writing-skills
description: Use when creating or editing any behavior-shaping content before deployment — skills (skills/*.md) or dispatched agents (agents/*.md). Both shape agent behavior and require the same TDD discipline: baseline pressure-test, write, close loopholes. File paths differ; methodology is identical.
