---
name: sp-feedback-role
description: Role skill for the Feedback agent of sp-harness. Invoked from skills/feedback (Mode A or Mode B) inside a dispatched general-purpose subagent. Diagnoses runtime regressions, routes findings to memory / new_todo / fix_feature / manual buckets, and writes feedback-actions.json.
