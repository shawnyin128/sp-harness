...
mkdir -p src test docs/sp-harness/plans

# Create a simple implementation plan
cat > docs/sp-harness/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/sp-harness/plans/implementation-plan.md using the subagent-driven-development skill.
...
# IMPORTANT: Run from sp-harness directory so local dev skills are available
PROMPT="Change to directory $TEST_PROJECT and then execute the implementation plan at docs/sp-harness/plans/implementation-plan.md using the subagent-driven-development skill.
